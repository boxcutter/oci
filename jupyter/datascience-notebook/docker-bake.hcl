...
target "_common" {
  ...
  tags = [
    ...
    "${CONTAINER_REGISTRY}/${IMAGE_NAME}:julia-1.10.0",
    "${CONTAINER_REGISTRY}/${IMAGE_NAME}:r-4.3.2",
    "${CONTAINER_REGISTRY}/${IMAGE_NAME}:latest"
  ]
  labels = {
    "org.opencontainers.image.source" = "https://github.com/boxcutter/oci"
    "org.opencontainers.image.licenses" = "Apache-2.0"
    "org.opencontainers.image.description" = "Jupyter Notebook Data Science Stack."
