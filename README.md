...
| [shellcheck](https://hub.docker.com/r/boxcutter/shellcheck) | Containerfile/Dockerfiles linter | [src/lint/shellcheck](https://github.com/boxcutter/oci/tree/main/src/lint/shellcheck) |
